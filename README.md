...
最新版本:---1.28 1.增加稳定性:适配多个游戏:永劫无间等2.支持多开批量冻结---更新日期2024 / 5 / 7 (最近一个月更新非常快,请关注获取最新特性)---
...
更新日志:
    ...
    V1.28
    1.加入:安全模式, 适用于某些反调试窗体的游戏,例如:永劫无间等( 冻结/解冻有问题你就勾选这一项,再不行就反馈 感谢:容之 提供线索)
    2.加入:多开进程批量全局冻结/解冻功能.  例如10个浏览器....10个模拟器...10个xxxx(之前仅能单个)  (感谢:**隆(佚名) 提供线索)
