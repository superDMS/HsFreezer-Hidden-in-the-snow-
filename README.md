...
最新版本:1.11
    ...
    v1.12
    1.移除解锁快捷键:原因,有些游戏ctrl,alt,shift等键为某功能键,唤醒同时会把多余键位信息带到游戏中,导致某些误发操作.(比如急冻时是潜行状态, 快捷键一唤醒,尾段按压信息传入游戏中来飞扑.......)所以解锁操作还是用点击按钮等方式进行比较稳妥,属实没料到这种特殊情节.
    2.增加睡眠和休眠稳定性.
    3.增加使用呼出主界面快捷键后是否在光标位置呼出雪藏选项.
