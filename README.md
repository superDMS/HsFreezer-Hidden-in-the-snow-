...
最新版本:---1.39 1.37重大内核级更新,冻结能力大幅提升,可冻结包含但不仅限于:LOL,崩坏3,无畏契约等等任务管理器都搞不定的网游进程以及之前你冻不住的进程,之前说冻到后台还有声音的朋友赶紧来尝试.1.优化:进阶/休闲面板切换流畅的.2.改进:进阶/休闲面板进程列表统一.3.优化:雪藏在前台时CPU占用逻辑.4.优化:列表响应反馈.---更新日期2024 / 5 / 12 (最近一个月更新非常快,因为大批量密集测试,疯狂改bug中,如果有异常,也许隔一会来着看看更新日志就修复了,请关注获取最新特性)---
