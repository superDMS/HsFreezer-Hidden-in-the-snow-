...
最新版本:1.08
    ...
    v1.10
    1.加入 "呼出主界面快捷键":ctrl+alt+x    以及"单锁模式下解冻"快捷键: ctrl+alt+e (均可修改)  掌机用户可映射至某个自定义键上. 键盘鼠党就随意啦.
