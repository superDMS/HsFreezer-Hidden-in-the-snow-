...
更新日志:
    ...
    v0.01
    弹窗模式初代雪藏于2017年建立 (当时80行代码,自用,迭代至今, 现GUI界面+逻辑处理代码总量13700+行,持续增加中..窗体线程操作与各种瞬发体验是大头...如果纯实现挂起那不如用ZY监视器,要的就是在体验中追求极,不然何必打磨?当然,你喜欢反复到资源管理器里的列表里一个个翻,且能忍受他呼出的繁琐,当我没说.)
