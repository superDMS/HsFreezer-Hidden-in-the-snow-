...
最新版本:---1.42 1.修复:隐藏雪藏后点击任务栏图标会导致多开雪藏的问题2.新用户默认关闭妙控拖拽.---更新日期2024 / 5 / 12 (最近一个月更新非常快,因为大批量密集测试,疯狂改bug中,如果有异常,也许隔一会来着看看更新日志就修复了,请关注获取最新特性)---
