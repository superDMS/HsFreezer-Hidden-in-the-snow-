...
最新版本:---1.25---更新日期2024 / 5 / 4 (最近一个月更新非常快,请关注获取最新特性)---
...
视频演示3: https://www.bilibili.com/video/BV19H4y137hx/(感谢up主:甜蜜的泡芙 制作) 
...
6.解冻后,建议等待游戏窗口完全静止后再进行操作, 否则可能导致按键某卡住, 如果卡住
可以切除桌面或者多按几下卡住的按键即可解除, 或重新冻结解冻一遍, 尽量用窗口化或者无边框全屏模式.
